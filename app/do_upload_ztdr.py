...
excel_path = "D:\\code\\LHSextract\\三会一课未上传\\三会一课未上传名单.xlsx"#未上传名单的路径
...
def main(args:list[str]):
    ...
    for qy in data_dict:
        ...
        commen_button(wait, driver, xpath="//div[@class = 'fs-select-dropdown fs-popper']//ul[@class = 'fs-scrollbar__view fs-select-dropdown__list']/li[1]")
